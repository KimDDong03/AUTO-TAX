          ...
          <div className="portal-action-stack">
            <section className="auth-card portal-login-card portal-login-primary-card" id="public-login-card">
              <div className="auth-copy">
                ...
                <h1>{PUBLIC_PORTAL_COPY.loginTitle}</h1>
            ...
            <section className="auth-card portal-consult-card portal-secondary-login-card" id="public-consultation-card">
              <div className="auth-copy">
                <span className="auth-badge">상담 신청</span>
                <h2>{PUBLIC_PORTAL_COPY.title}</h2>
              ...
              <form className="auth-form" onSubmit={onConsultationSubmit}>
                ...
                <div className="auth-actions portal-login-actions">
                  <button type="submit" className="btn-secondary" disabled={consultationBusy}>

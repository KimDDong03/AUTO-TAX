...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776394519886-gmhai8 | 2026-04-17T02:55:21.023Z

**Codebase Map:**
  scripts/: build-renewal-local-helper-package, e2e-smoke, fix-popbill-package, popbill-cert-registration.test, popbill-cert-registration, public-access-portal-smoke, renewal-agent, renewal-local-helper, signgate-fee-payment
  api/: index
  server/: address-resolver, admin-types, api-access.test, api-access, app-shell, auth-user-service, auth-utils.test, auth-utils, automation, bootstrap-routes.test
  supabase/: index
  web/: App, api-url, api.test, api, ui, CertificatesScreen, CertificatesTab, useCertificatesScreenModel, CustomersTab, InitialRegistrationTab
